...
public class Risk extends Thread {
    ...
    public static final String[] types = new String[]{"human", "ai easy", "ai easy", "ai easy", "ai average",
        "ai average"};
    ...
    private void processFromUI(String message) {
        ...
        if (message.equals("ver")) {
            ...
            controller.sendMessage(RiskUtil.GAME_NAME + " Game Engine [Version " + RiskUtil.RISK_VERSION + "]", false,
                    false);
            getInput();
        } // take no action
            ...
            if (input.equals("closegame")) {
                ...
                if (StringT.hasMoreTokens() == false) {
                    ...
                    output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "replay");
                }
    ...
    private void noGameParser(String message) {
        ...
        if (input.equals("newgame")) {
            ...
            if (StringT.hasMoreTokens() == false) {
                ...
                output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "newgame");
            }
            ...
            if (StringT.countTokens() >= 1) {
                ...
                try {
                    ...
                    if (player != null) {
                        ...
                        output = output + System.getProperty("line.separator")
                                + resb.getString("core.loadgame.currentplayer") + " " + player.getName();
                    }
                ...
                output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "loadgame filename");
            }
            ...
            if (StringT.countTokens() == 1) {
                ...
                output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "join server");
            }
            ...
            if (StringT.hasMoreTokens() == false) {
                ...
                output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "startserver");
            }
            ...
            if (StringT.hasMoreTokens() == false) {
                ...
                output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "killserver");
            }
    ...
    protected void inGameParser(final String message) {
        ...
        if (Addr.equals("ERROR")) { // server has sent us a error
            ...
            if (game.getCurrentPlayer() != null && !(game.getCurrentPlayer().getAddress().equals(id)
            ...
            output = resb.getString("core.dice.rolling") + System.getProperty("line.separator")
            ...
            if (result[0] == 1) {
                output = output + RiskUtil.replaceAll(
                        RiskUtil.replaceAll(resb.getString("core.dice.result"), "{0}", String.valueOf(result[2])) // defeated
                ...
                if (result[3] == 0) {
                    ...
                    if (result[4] == result[5]) {
                        ...
                        output = output + RiskUtil.replaceAll(resb.getString("core.dice.armiesmoved"), "{0}",
                                String.valueOf(noa));
                        ...
                        output = output
                                + RiskUtil.replaceAll(RiskUtil.replaceAll(resb.getString("core.dice.howmanyarmies"),
                                        "{0}", String.valueOf(result[4])), "{1}", String.valueOf(result[5]));
                    }
            ...
            if (unlimitedLocalMode && game.getSetupDone() && newplayer.getName().equals("Theo")) {
            ...
            game.placeArmy(c, 1);
            controller.sendMessage(RiskUtil.replaceAll(resb.getString("core.place.oneplacedin"), "{0}", c.getName()),
                    false, false); // Display
            ...
            for (int c = 0; c < game.getNoCountries(); c++) {
                ...
                controller.sendMessage(
                        RiskUtil.replaceAll(RiskUtil.replaceAll(resb.getString("core.place.getcountry"), "{0}",
                                ((Player) game.getCurrentPlayer()).getName()), "{1}", t.getName()) // Display
                        , false, false);
                game.endGo();
            }
            ...
            output = RiskUtil.replaceAll(resb.getString("core.player.newselected"), "{0}",
            ...
            if (game != null && game.getCurrentPlayer() != null && game.getState() != RiskGame.STATE_GAME_OVER) {
                ...
                controller.sendMessage(game.getCurrentPlayer().getName() + "(" + typeString + ")>" + echo, false,
                        false);
            } else {
            ...
            if (game.getState() == RiskGame.STATE_NEW_GAME) {
                ...
                if (input.equals("choosemap")) {
                    ...
                    if (StringT.countTokens() >= 1) {
                        ...
                        output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "choosemap filename");
                    }
                    ...
                    if (StringT.countTokens() >= 1) {
                        ...
                        output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}",
                    ...
                    if (StringT.countTokens() >= 3) {
                        ...
                        if (color != 0 && t != -1 && !name.equals("")
                            ...
                            output = RiskUtil.replaceAll(
                                    RiskUtil.replaceAll(resb.getString("core.newplayer.created"), "{0}", name), "{1}",
                                    c);

                            controller.addPlayer(t, name, color, Addr);
                            // System.out.print("New player has Address:
                            // "+Addr+"\n");

                        } else {
                            output = resb.getString("core.newplayer.error.unable");
                        }
                    ...
                    if (StringT.countTokens() >= 1) {
                        ...
                        if (game.delPlayer(name)) {
                            ...
                            output = resb.getString("core.delplayer.error.unable");
                        }
                    } else {
                        output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "delplayer name");
                    }
                    ...
                    if (StringT.hasMoreTokens() == false) {
                        ...
                        for (int a = 0; a < players.size(); a++) {
                            ...
                            output = output + resb.getString("core.info.player") + " "
                        ...
                        output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "info");
                    }
                    ...
                    if (StringT.hasMoreTokens() == false) {
                        ...
                        if (game.getPlayers().size() == 0) {
                            ...
                            if (!replay) {
                                ...
                                for (int c = 1; c <= RiskGame.MAX_PLAYERS; c++) {
                                    ...
                                    parser("newplayer " + riskconfig.getProperty("default.player" + c + ".type") + " "
                                            + riskconfig.getProperty("default.player" + c + ".color") + " "
                                            + riskconfig.getProperty("default.player" + c + ".name"));
                        ...
                        output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "autosetup");
                    }
                    ...
                    if (StringT.countTokens() >= 1) {
                        ...
                        output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "play filename");
                    }
                } else {
                    output = RiskUtil.replaceAll(resb.getString("core.error.incorrect"), "{0}",
                ...
                try {
                    ...
                    if (input.equals("undo")) {
                        ...
                        if (StringT.hasMoreTokens() == false) {
                            ...
                            if (unlimitedLocalMode) {
                                ...
                                try {
                                    ...
                                    if (game.getState() != RiskGame.STATE_DEFEND_YOURSELF && Undo != null
                                            && Undo.size() != 0) {
                                        // game = (RiskGame)Undo.getObject(
                                        // nullCipher );
                                        ObjectInputStream in = new ObjectInputStream(
                                                new ByteArrayInputStream(Undo.toByteArray()));
                            ...
                            output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "undo");
                        }
                        ...
                        if (StringT.hasMoreTokens() == false) {
                            ...
                            output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "showmission");
                        }
                        ...
                        if (StringT.hasMoreTokens() == false) {
                                ...
                                for (int c = 0; c < v.length; c++) {
                                    ...
                                    if (v[c].getOwner() != null) {
                                        output = output + ((Player) v[c].getOwner()).getName() + " (" + v[c].getArmies()
                                                + ")";
                                        if (game.getGameMode() == 2 && game.getSetupDone()
                                            ...
                                            for (int a = 0; a < players.size(); a++) {
                                                ...
                                                if (((Player) players.get(a)).getCapital() != null
                                                        && ((Player) players.get(a)).getCapital() == v[c]) {
                                                    output = output + " "
                                                            + RiskUtil.replaceAll(
                                                                    resb.getString("core.showarmies.captial"), "{0}",
                                                                    ((Player) players.get(a)).getName());
                                                }
                                        ...
                                        output = output + resb.getString("core.showarmies.noowner")
                                                + System.getProperty("line.separator");
                                    }
                            ...
                            output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "showarmies");
                        }
                        ...
                        if (StringT.hasMoreTokens() == false) {
                            ...
                            if (showHumanPlayerThereInfo()) {
                                ...
                                if (c.size() == 0) {
                                    ...
                                    for (int a = 0; a < c.size(); a++) {
                                        ...
                                        if (((Card) c.get(a)).getName().equals(Card.WILDCARD)) {
                                            ...
                                            output = output + " \"" + ((Card) c.get(a)).getName() + " "
                                                    + ((Country) ((Card) c.get(a)).getCountry()).getName() + " ("
                                                    + ((Country) ((Card) c.get(a)).getCountry()).getColor() + ")\""; // Display
                                        }
                                ...
                                if (game.getCardMode() == RiskGame.CARD_FIXED_SET) {
                                    ...
                                    output = output + "\n" + RiskUtil.replaceAll(resb.getString("cards.nexttrade"),
                                            "{0}", String.valueOf(getNewCardState()));
                                }
                            ...
                            output = RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "showcards");
                        }
                        ...
                        if (StringT.hasMoreTokens() == false) {
                            ...
                            output = RiskUtil.replaceAll(resb.getString("core.autoendgo.setto"), "{0}",
                            ...
                            if (option.equals("on")) {
                                ...
                                output = RiskUtil.replaceAll(resb.getString("core.autoendgo.error.unknown"), "{0}",
                                        option);
                            }
                        ...
                        if (StringT.hasMoreTokens() == false) {
                            ...
                            output = RiskUtil.replaceAll(resb.getString("core.autodefend.setto"), "{0}",
                                    resb.getString(strSelected));
                        } else if (StringT.countTokens() == 1) {
                            ...
                            if (option.equals("on")) {
                                ...
                                output = RiskUtil.replaceAll(resb.getString("core.autodefend.error.unknown"), "{0}",
                                        option);
                            }
                        ...
                        if (input.equals("trade")) {
                            if (StringT.countTokens() == 3) {
                                ...
                                Card cards[] = game.getCards(StringT.nextToken(), StringT.nextToken(),
                                        StringT.nextToken());

                                if (cards[0] != null && cards[1] != null && cards[2] != null) { // if
                                    // the
                                    // player
                                    // DOES
                                    // HAVE
                                ...
                                if (noa != 0) { // if the trade WAS SUCCESSFUL
                                    ...
                                    throw new IllegalArgumentException(resb.getString("core.trade.error.unable"));
                                }
                            } else {
                                throw new IllegalArgumentException(RiskUtil.replaceAll(
                                        resb.getString("core.error.syntax"), "{0}", "trade card card card"));
                            }
                            ...
                            if (StringT.hasMoreTokens() == false) {
                                ...
                                if (game.endTrade()) {
                                    ...
                                    throw new IllegalArgumentException(resb.getString("core.trade.end.error.unable"));
                                }
                            } else {
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "endtrade"));
                            }
                        } else {
                            throw new IllegalArgumentException(
                                    RiskUtil.replaceAll(resb.getString("core.error.incorrect"), "{0}",
                                            "showcards, trade" + (game.canEndTrade() ? ", endtrade" : "")));
                        }
                        ...
                        if (input.equals("placearmies")) {
                            if (StringT.countTokens() == 2) {
                                ...
                                if (t != null && num != -1 && !(game.getGameMode() == 1 && t.getOwner() == null)
                                    ...
                                    if (result != 0) {
                                        ...
                                        output = RiskUtil
                                                .replaceAll(RiskUtil.replaceAll(resb.getString("core.place.placed"),
                                                        "{0}", String.valueOf(num)), "{1}", t.getName()); // Display
                                        ...
                                        throw new IllegalArgumentException(resb.getString("core.place.error.unable"));
                                    }
                                } else {
                                    throw new IllegalArgumentException(resb.getString("core.place.error.invalid"));
                                }
                            } else {
                                throw new IllegalArgumentException(RiskUtil.replaceAll(
                                        resb.getString("core.error.syntax"), "{0}", "placearmies country number"));
                            }
                            ...
                            if (!StringT.hasMoreTokens()) {
                                ...
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "autoplace"));
                            }
                        } else {
                            throw new IllegalArgumentException(
                                    RiskUtil.replaceAll(resb.getString("core.error.incorrect"), "{0}",
                        ...
                        if (input.equals("attack")) {
                            if (StringT.countTokens() == 2) {
                                ...
                                if (a) {
                                    ...
                                    throw new IllegalArgumentException(resb.getString("core.attack.error.unable"));
                                }
                            } else {
                                throw new IllegalArgumentException(RiskUtil.replaceAll(
                                        resb.getString("core.error.syntax"), "{0}", "attack country country"));
                            }
                            ...
                            if (StringT.hasMoreTokens() == false) {
                                ...
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "endattack"));
                            }
                        } else {
                            throw new IllegalArgumentException(RiskUtil
                                    .replaceAll(resb.getString("core.error.incorrect"), "{0}", "attack, endattack"));
                        }
                        ...
                        if (input.equals("roll")) {
                            ...
                            if (StringT.countTokens() == 1) {
                                ...
                                if (dice != -1 && game.rollA(dice)) {
                                    ...
                                    output = RiskUtil.replaceAll(RiskUtil.replaceAll(resb.getString("core.roll.rolled"),
                                            "{0}", ((Player) game.getCurrentPlayer()).getName()), "{1}", "" + n);
                                    ...
                                    throw new IllegalArgumentException(resb.getString("core.roll.error.unable"));
                                }
                            } else {
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "roll number"));
                            }
                            ...
                            if (StringT.hasMoreTokens() == false) {
                                ...
                                if (game.retreat()) {
                                    ...
                                    throw new IllegalArgumentException(resb.getString("core.retreat.error.unable"));
                                }
                            } else {
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "retreat"));
                            }
                        } else {
                            throw new IllegalArgumentException(RiskUtil
                                    .replaceAll(resb.getString("core.error.incorrect"), "{0}", "roll, retreat"));
                        }
                        ...
                        if (input.equals("move")) {
                            if (StringT.countTokens() == 1) {
                                ...
                                if (mov != 0) {
                                    ...
                                    throw new IllegalArgumentException(resb.getString("core.move.error.unable"));
                                }
                            } else {
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "move number"));
                            }
                        } else {
                            throw new IllegalArgumentException(
                                    RiskUtil.replaceAll(resb.getString("core.error.incorrect"), "{0}", "move"));
                        }
                        ...
                        if (input.equals("movearmies")) {
                            if (StringT.countTokens() == 3) {
                                ...
                                if (game.moveArmy(country1, country2, noa)) {
                                    ...
                                    output = RiskUtil.replaceAll(
                                            RiskUtil.replaceAll(
                                                    RiskUtil.replaceAll(resb.getString("core.tacmove.movedfromto"),
                                                            "{0}", "" + noa),
                                ...
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}",
                            ...
                            if (StringT.hasMoreTokens() == false) {
                                if (game.noMove()) {
                                    ...
                                    throw new IllegalArgumentException(resb.getString("core.tacmove.no.error.unable"));
                                }
                            } else {
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "nomove"));
                            }
                        } else {
                            throw new IllegalArgumentException(RiskUtil
                                    .replaceAll(resb.getString("core.error.incorrect"), "{0}", "movearmies, nomove"));
                        }
                        ...
                        if (input.equals("endgo")) {
                            if (StringT.hasMoreTokens() == false) {
                                ...
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "endgo"));
                            }
                        } else {
                            throw new IllegalArgumentException(
                                    RiskUtil.replaceAll(resb.getString("core.error.incorrect"), "{0}", "emdgo"));
                        }
                        ...
                        if (input.equals("continue")) {
                            if (StringT.hasMoreTokens() == false) {
                                ...
                                throw new IllegalArgumentException(
                                        RiskUtil.replaceAll(resb.getString("core.error.syntax"), "{0}", "continue"));
                            }
                        } else {
                            // The game is over. {0} won! (current possible
                            // commands are: continue)
                            throw new IllegalArgumentException(RiskUtil.replaceAll(resb.getString("core.gameover.won"),
                                    "{0}", game.getCurrentPlayer().getName()));
                        }
                        ...
                        if (input.equals("capital")) {
                            if (StringT.countTokens() == 1) {
                                ...
                                if (t != null && game.setCapital(t)) {
                                    if (showHumanPlayerThereInfo()) {
                                        output = RiskUtil.replaceAll(resb.getString("core.capital.selected"), "{0}",
                                                t.getName()); // Display
                                    } else {
                                ...
                                throw new IllegalArgumentException(RiskUtil
                                        .replaceAll(resb.getString("core.error.syntax"), "{0}", "capital country"));
                            }
                        } else {
                            throw new IllegalArgumentException(
                                    RiskUtil.replaceAll(resb.getString("core.error.incorrect"), "{0}", "capital"));
                        }
                        ...
                        if (input.equals("roll")) {
                            ...
                            throw new IllegalArgumentException(
                                    RiskUtil.replaceAll(resb.getString("core.error.incorrect"), "{0}", "roll"));
                        }

                    } else {
                        throw new IllegalStateException(resb.getString("core.error.unknownstate"));
                    }
                } catch (IllegalArgumentException ex) {
                    if (aiPlayer) {
                        logger.log(Level.WARNING, "bad command from ai: \"" + message + "\" player="
                                + game.getCurrentPlayer() + " state=" + game.getState(), ex);
                    }
    ...
    private boolean showHumanPlayerThereInfo(Player p) {
        return game.getState() == RiskGame.STATE_GAME_OVER || ((p != null) && (p.getType() == Player.PLAYER_HUMAN)
    ...
    public void getInput() {
        ...
        if (game == null) {
        ...
        else if (game != null && game.getCurrentPlayer() != null && game.getState() != RiskGame.STATE_GAME_OVER) {// if
            // player
            // type
            // is
            // human
            ...
            if (game.getState() == RiskGame.STATE_TRADE_CARDS) {
                controller.sendMessage(RiskUtil.replaceAll(resb.getString("core.input.newarmies"), "{0}",
                        ((Player) game.getCurrentPlayer()).getExtraArmies() + ""), false, false);
                // controller.armiesLeft(
                // ((Player)game.getCurrentPlayer()).getExtraArmies() ,
                // game.NoEmptyCountries() );
            } else if (game.getState() == RiskGame.STATE_PLACE_ARMIES) {
                controller.sendMessage(RiskUtil.replaceAll(resb.getString("core.input.armiesleft"), "{0}",
                        ((Player) game.getCurrentPlayer()).getExtraArmies() + ""), false, false);
                // controller.armiesLeft(
                // ((Player)game.getCurrentPlayer()).getExtraArmies() ,
                // game.NoEmptyCountries() );
    ...
    public String whoWon() {
        ...
        if (game.getGameMode() == RiskGame.MODE_SECRET_MISSION) {
            // There mission was: {0}
            text = text + System.getProperty("line.separator") + RiskUtil
                    .replaceAll(resb.getString("core.whowon.mission"), "{0}", winner.getMission().getDiscription());
        }
        return text;
    }
    ...
    public void setHelp() {
        ...
        if (game == null) {
            ...
            help = RiskUtil.replaceAll(resb.getString("core.help.gameover"), "{0}",
                    ((Player) game.getCurrentPlayer()).getName());
        } else if (game.getState() == RiskGame.STATE_SELECT_CAPITAL) {
     ...
     * (Country)game.getCountry(d) ) ) { return true; } else { return false; }
     *
     * }
     */
    /**
    ...
    public boolean isOwnedCurrentPlayerInt(int name) {
        ...
        return ((game != null && game.getCurrentPlayer() != null && game.getCountryInt(name) != null)
                && (((Country) game.getCountryInt(name)).getOwner() == null
                || ((Country) game.getCountryInt(name)).getOwner() == game.getCurrentPlayer()));
     ...
     *
     * public String getCountryDisplayName(int nCountryId) { Country country =
     * game.getCountryInt( nCountryId); if (country == null) { return ""; } else
     * { return country.getName(); // Display } }//public String
     * getCountryDisplayName(int nCountryId)
     */
    /**
    ...
    public void newMemoryGame(RiskGame g, String map) {
        ...
        /**
         * @see
         * net.yura.domination.ui.swinggui.SwingGUIPanel#showMapImage(javax.swing.Icon)
         */
        unlimitedLocalMode = true;
    }
    ...
    private void renamePlayer(String name, String newName, String newAddress, int newType) {
        ...
        if (newNamePlayer != null && !name.equals(newName)) {
            throw new IllegalArgumentException("can not rename \"" + name + "\". someone with new name \"" + newName
